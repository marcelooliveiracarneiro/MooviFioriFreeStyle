			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovim08a02-display": {
								"semanticObject": "moovim08a02",
								"action": "display",
								"description": "Módulo 08, Aula 01 - CSS Customizado",
								"title": "CSS Customizado",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m08a02",
									"url": sap.ui.require.toUrl("moovi/m08a02")
								}
							}
						}
					}
