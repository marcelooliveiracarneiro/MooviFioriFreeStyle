		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#moovizmoc_fiorilistdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovizmoc_fiorilistdetail-display": {
								"semanticObject": "moovizmoc_fiorilistdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.zmoc_fiorilistdetail",
									"url": sap.ui.require.toUrl("moovi/zmoc_fiorilistdetail")
								}
							}
						}
					}
