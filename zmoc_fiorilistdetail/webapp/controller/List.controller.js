sap.ui.define([
    ...
    return BaseController.extend("moovi.zmoc_fiorilistdetail.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "moovi.zmoc_fiorilistdetail.view.ViewSettingsDialog",
                    controller: this
        ...
        onCompanyButtonNewPress: function ( oEvent ) {
        ...
        _initNewCompany: function ( oEvent ) {
            ...
            var oModelEdit =  oView.getModel("editCompanyModel");
