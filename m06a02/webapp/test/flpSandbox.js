			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovim06a02-display": {
								"semanticObject": "moovim06a02",
								"action": "display",
								"description": "Modulo 06, Aula 02 - Binding Property",
								"title": "Binding Property",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m06a02",
									"url": sap.ui.require.toUrl("moovi/m06a02")
								}
							}
						}
					}
