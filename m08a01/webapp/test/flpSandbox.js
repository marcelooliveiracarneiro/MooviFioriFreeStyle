					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formatações customizadas",
									"targetURL": "#moovim08a01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovim08a01-display": {
								"semanticObject": "moovim08a01",
								"action": "display",
								"description": "Módulo 08, Aula 01 - Formatações customizadas",
								"title": "Formatações customizadas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m08a01",
									"url": sap.ui.require.toUrl("moovi/m08a01")
								}
							}
						}
					}
