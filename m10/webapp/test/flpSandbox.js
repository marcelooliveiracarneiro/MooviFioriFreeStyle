			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovim10-display": {
								"semanticObject": "moovim10",
								"action": "display",
								"description": "Módulo 10 - Operações CRUD",
								"title": "Operações CRUD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m10",
									"url": sap.ui.require.toUrl("moovi/m10")
								}
							}
						}
					}
