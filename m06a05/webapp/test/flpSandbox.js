			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovim06a05-display": {
								"semanticObject": "moovim06a05",
								"action": "display",
								"description": "Módulo 06, Aula 05 - Expression Binding",
								"title": "Expression Binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m06a05",
									"url": sap.ui.require.toUrl("moovi/m06a05")
								}
							}
						}
					}
